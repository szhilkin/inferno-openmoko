...
void statebefore(char* o, char* q, uchar op, Inst* modprog)
{
...
#define I(r) (*(Inst**)R.r - modprog)
        ...
        case IBEQB:     snprint(o,n,"jmp if(%d == %d)", B(s), B(m)); break;  // diadic and triadic
        case IBNEB:     snprint(o,n,"jmp if(%d != %d)", B(s), B(m)); break;
        case IBLTB:     snprint(o,n,"jmp if(%d <  %d)", B(s), B(m)); break;
        case IBLEB:     snprint(o,n,"jmp if(%d <= %d)", B(s), B(m)); break;
        case IBGTB:     snprint(o,n,"jmp if(%d >  %d)", B(s), B(m)); break;
        case IBGEB:     snprint(o,n,"jmp if(%d >= %d)", B(s), B(m)); break;
        case IBEQW:     snprint(o,n,"jmp if(%d == %d)", W(s), W(m)); break;
        case IBNEW:     snprint(o,n,"jmp if(%d != %d)", W(s), W(m)); break;
        case IBLTW:     snprint(o,n,"jmp if(%d <  %d)", W(s), W(m)); break;
        case IBLEW:     snprint(o,n,"jmp if(%d <= %d)", W(s), W(m)); break;
        case IBGTW:     snprint(o,n,"jmp if(%d >  %d)", W(s), W(m)); break;
        case IBGEW:     snprint(o,n,"jmp if(%d >= %d)", W(s), W(m)); break;
        case IBEQL:     snprint(o,n,"jmp if(0x%llX == 0x%llX)", V(s), V(m)); break;
        case IBNEL:     snprint(o,n,"jmp if(0x%llX != 0x%llX)", V(s), V(m)); break;
        case IBLTL:     snprint(o,n,"jmp if(0x%llX <  0x%llX)", V(s), V(m)); break;
        case IBLEL:     snprint(o,n,"jmp if(0x%llX <= 0x%llX)", V(s), V(m)); break;
        case IBGTL:     snprint(o,n,"jmp if(0x%llX >  0x%llX)", V(s), V(m)); break;
        case IBGEL:     snprint(o,n,"jmp if(0x%llX >= 0x%llX)", V(s), V(m)); break;
        case IBEQF:     snprint(o,n,"jmp if(%f == %f)", F(s), F(m)); break;
        case IBNEF:     snprint(o,n,"jmp if(%f != %f)", F(s), F(m)); break;
        case IBLTF:     snprint(o,n,"jmp if(%f <  %f)", F(s), F(m)); break;
        case IBLEF:     snprint(o,n,"jmp if(%f <= %f)", F(s), F(m)); break;
        case IBGTF:     snprint(o,n,"jmp if(%f >  %f)", F(s), F(m)); break;
        case IBGEF:     snprint(o,n,"jmp if(%f >= %f)", F(s), F(m)); break;
        case IBEQC:     snprint(o,n,"jmp if(\"%s\" == \"%s\")", string2c(S(s)), string2c(S(m))); break;
        case IBNEC:     snprint(o,n,"jmp if(\"%s\" != \"%s\")", string2c(S(s)), string2c(S(m))); break;
        case IBLTC:     snprint(o,n,"jmp if(\"%s\" <  \"%s\")", string2c(S(s)), string2c(S(m))); break;
        case IBLEC:     snprint(o,n,"jmp if(\"%s\" <= \"%s\")", string2c(S(s)), string2c(S(m))); break;
        case IBGTC:     snprint(o,n,"jmp if(\"%s\" >  \"%s\")", string2c(S(s)), string2c(S(m))); break;
        case IBGEC:     snprint(o,n,"jmp if(\"%s\" >= \"%s\")", string2c(S(s)), string2c(S(m))); break;
        ...
        case ISPAWN:
        case ICALL:     snprint(o,n,"Frame@%p FP=Frame@%p", (Frame*)T(s), R.FP); break;
        case IJMP:      break;
